...
import '../top_tabs/category_tab6.dart';
import '../top_tabs/category_tab7.dart';
import '../top_tabs/category_tab8.dart';
import '../top_tabs/category_tab9.dart';
...
class _TabMediumState extends State<TabMedium> {
  ...
  void _scrollListener() async {
    ...
    final cb9 = context.read<CategoryTab9Bloc>();
    ...
    if (sb.tabIndex == 0) {
      ...
      if (isEnd) {
        debugPrint("reached the bottom -t9");
        cb9.pageIncreament();
        cb9.setLoading(true);
        await cb9
            .fetchData(WpConfig.selectedCategories['9'][0], mounted)
            .then((value) {
          cb9.setLoading(false);
        });
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    return TabBarView(
      children: <Widget>[
        ...
        CategoryTab9(
          categoryId: WpConfig.selectedCategories['9'][0],
          scaffoldKey: widget.scaffoldKey,
        ),
      ],
